...
exports.init = function(genericAWSClient) {
  // Creates an MWSOrders API client
  // <HACK> Modified by Benjamin (reason: Take a hash as params instead of formal parameters)
  var createMWSOrdersClient = function (sellerId, accessKeyId, secretAccessKey, options) {
  //  var createEC2Client = function (accessKeyId, secretAccessKey, options) {
    ...
    var client = MWSOrdersClient({
      host: options.host || "mws.amazonservices.fr",
      path: options.path || "/Orders/2011-01-01",
      sellerId: sellerId,
...
//    });
  ...
  // Amazon MWSOrders API handler which is wrapped around the genericAWSClient
  var MWSOrdersClient = function(obj) {
